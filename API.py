...
def getHotels(nameOfCity):
	x = parse(nameOfCity,datetime.strptime("2017/11/11","%Y/%m/%d"),datetime.strptime("2017/11/12","%Y/%m/%d"),"popularity")
	#return x
	return [el['hotel_name'] for el in x]
